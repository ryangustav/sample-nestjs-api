    ...
    items: [
      {
        ...
        description: 'Gera um novo código de 12 caracteres com tempo de expiração.',
        auth: true,
        body: {
          nome: 'string — nome do usuário que comprou',
          tempo: 'string (ISO 8601) — data de expiração',
        },
        response: {
          _id: 'string',
        ...
        example: {
          request: '{\n  "nome": "João Silva",\n  "tempo": "2026-03-20T00:00:00.000Z"\n}',
      ...
      },
      {
        ...
        description: 'Verifica se um código é válido e retorna info do usuário. Rota pública.',
        auth: false,
        body: null,
        response: {
          valid: 'boolean',
        ...
        example: {
          request: 'GET /api/v1/codes/verify/aB3kL9mNpQ2x',
          response: '{\n  "valid": true,\n  "nome": "João Silva",\n  "tempo": "2026-03-20T00:00:00.000Z"\n}',
        },
      },
    ],
